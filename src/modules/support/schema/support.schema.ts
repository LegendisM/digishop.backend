...
import { ISupport, SupportStatus } from "../interface/support.interface";
import { User } from "src/modules/user/schema/user.schema";
import { IUser } from "src/modules/user/interface/user.interface";

@Schema({ timestamps: true })
export class Support extends Document implements ISupport {
...
export const SupportSchema = SchemaFactory.createForClass<Support>(Support);