...
export class UserService {
    ...
    async getOneUser(filter: FilterQuery<User>, projection: IUser | object = {}): Promise<IUser> {
    ...
    async updateOneUser(filter: FilterQuery<User>, update: object | IUser): Promise<any> {
        return await this.userModel.updateOne(filter, update);
    }

    async updateManyUsers(filter: FilterQuery<User>, update: object | IUser): Promise<any> {
